...
+ (void)initialize
{
    ...
    appearance.titleColor = [UIColor colorWithWhite:0.05 alpha:1];
    appearance.messageColor = [UIColor darkGrayColor];
    appearance.titleFont = [UIFont fontWithName:@"GothamRounded-Bold" size:20];
    appearance.messageFont = [UIFont fontWithName:@"GothamRounded-Book" size:16];
    appearance.buttonFont = [UIFont fontWithName:@"GothamRounded-Book" size:([UIFont buttonFontSize] - 2)];
...
- (void)show
{
    ...
    if (!self.alertWindow) {
        ...
        [self.alertWindow addSubview:bg];
    }
...
- (void)validateLayout
{
	...
	if (self.titleLabel) {
        ...
        CGFloat height = [self heightForTitleLabel] + 5;
